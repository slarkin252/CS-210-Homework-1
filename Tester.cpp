...
int main()
{
    ...
    cout << "front: " << front << endl; //should this be back
    recordStatus(front == N - 1, &successes); //should this also output back for the test?
    ...
    classToTest.pop_front();
    front = classToTest.front();
    cout << "front after pop: " << front << endl << endl;
